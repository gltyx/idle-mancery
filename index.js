(function (factory) {
    ...
    const FooterUI = ({
      ...
      onClick: showVersion
    }, "v0.2.5"), VirtualDOM.createVirtualElement("p", {
      className: 'popup-link',
      onClick: showAbout
