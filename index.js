(function (factory) {
    ...
    const FooterUI = ({
      ...
      onClick: showVersion
    }, "v0.1.2"), VirtualDOM.createVirtualElement("p", {
      className: 'popup-link',
      onClick: showAbout
