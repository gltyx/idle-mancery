(function (factory) {
    ...
    const FooterUI = ({
      ...
      onClick: showVersion
    }, "v0.1.3a"), VirtualDOM.createVirtualElement("p", {
      className: 'popup-link',
      onClick: showAbout
    ...
    }, isUseCondensedTime ? 'Turn off' : 'Turn on') : null);
    const SidebarUI = ({
      resources,
      expanded,
      isUseCondensedTime
    ...
    const Skills = ({
      ...
      }, "-", amount) : null, VirtualDOM.createVirtualElement("span", {
        className: 'effort'
    ...
    const BuildingQueue = ({
      ...
      className: 'summary'
    }, VirtualDOM.createVirtualElement("p", null, "Building queue: ", queue.length, " of ", maxQueue)), queue.map((item, index) => VirtualDOM.createVirtualElement("div", {
    ...
    const Heirlooms = () => {
      ...
      }, VirtualDOM.createVirtualElement("h4", null, "Inventory"), VirtualDOM.createVirtualElement("p", null, "Items here will be removed after you reset"), VirtualDOM.createVirtualElement(HeirloomsRow, {
