(function (factory) {
    ...
    const FooterUI = ({
      ...
      onClick: showVersion
    }, "v0.1.3"), VirtualDOM.createVirtualElement("p", {
      className: 'popup-link',
      onClick: showAbout
